...
# adapted from https://github.com/jafingerhut/p4-guide/blob/dc25ab6d8bbdd5af12d572746c47807cc38274ab/bin/install-p4dev-v6.sh
...
# use an adapted PI
git clone https://github.com/dyc2021/PI.git
cd PI
git submodule update --init --recursive
git log -n 1
./autogen.sh
...
sudo make -j2
# we install PI using deb packet
sudo checkinstall
...
# git pull
# git log -n 1
git clone https://github.com/dyc2021/runtime-programmable-switch.git
cd runtime-programmable-switch/
git checkout grpc_support
git log -n 1
